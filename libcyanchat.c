...
{
	purple_debug_misc("cyanchat", "Initializing plugin\n");

	PurpleAccountOption* option;
	PurplePluginInfo* info = plugin->info;
	PurplePluginProtocolInfo* prpl_info = info->extra_info;

	/* ADVANCED USERLIST PARSING
	This will allow the use of less-traditional userlist comparisons
	to properly handle users renaming rather than simply overwriting
	the existing userlist with a new one. */
	option = purple_account_option_bool_new(_("Advanced User-list Parsing"), "userlist_magic", TRUE);
...
static PurplePluginProtocolInfo prpl_info = {
	/* options */
	OPT_PROTO_NO_PASSWORD | OPT_PROTO_SLASH_COMMANDS_NATIVE | OPT_PROTO_UNIQUE_CHATNAME,
	NULL,	/* user_splits */
	...
	/**/cyanchat_chat_info_defaults,	/* chat_info_defaults */
	/**/cyanchat_login,	/* login */
	/**/cyanchat_close,	/* close */
	/**/cyanchat_send_im,	/* send_im */
	NULL,	/* set_info */
	NULL,	/* send_typing */
	NULL/*cc_get_info*/,	/* get_info */
	NULL,	/* set_status */
	NULL,	/* set_idle */
	NULL,	/* change_passwd */
	NULL,	/* add_buddy */
	...
	NULL,	/* set_buddy_icon */
	NULL,	/* remove_group */
	/**/cyanchat_cb_real_id,	/* get_cb_real_name */
	NULL,	/* set_chat_topic */
